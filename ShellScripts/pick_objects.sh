...
sleep 6
xterm  -e "source /opt/ros/kinetic/setup.bash; source /home/nvidia/catkin_ws/devel/setup.bash; export TURTLEBOT_3D_SENSOR=kinect; roslaunch pick_objects pick_objects_rviz.launch" & 
sleep 6
